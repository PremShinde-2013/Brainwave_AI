		...
		<div className="flex relative font-geistSans overflow-hidden items-center justify-between min-h-screen">
			<div className="relative w-full lg:w-1/2 flex items-center min-h-screen bg-page-gradient  p-8 border-r-[1px] border-white/5">
				<div className="absolute top-0 left-0 p-8 text-white inline-flex gap-2 items-center">
					<Image
						...
						className="hover:brightness-125 duration-200 rounded-full bg-black"
					/>
					<span className="text-xl text-transparent bg-clip-text bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500">Brainwave.ai</span>
				</div>
				...
				<div className="pl-4 z-20">
					<h1 className="text-5xl text-black dark:text-white mb-8 tracking-tighter">
						Hello,{" "}
						<span
							className={cn(
								"bg-gradient-to-tr bg-no-repeat  from-purple-500 via-violet-500 to-pink-500 text-transparent bg-clip-text animate-gradient", gradientStyle.magicText,
					...
					<div className="text-slate-500 mt-16 z-20">
						...
						and
						<Link href="/privacy" className=" text-black dark:text-slate-200">
							{" "}
							Privacy Policy
						</Link>
					</div>
			...
			<div className="relative hidden w-0 lg:flex lg:w-1/2  flex-col items-center justify-center min-h-screen bg-page-gradient overflow-hidden">
				...
				<span className="text-3xl leading-relaxed tracking-tighter mb-8">
					Ready for your{" "}
					<span className="text-slate-800 dark:text-white font-bold">Second brain</span>?
				</span>
