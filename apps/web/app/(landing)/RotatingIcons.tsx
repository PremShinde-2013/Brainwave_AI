	...
	return (
		<div className="relative flex w-full flex-col items-center justify-center gap-8 px-4 sm:px-6 mt-10">
			<motion.h1
				...
				className="text-center max-w-2xl  mx-auto dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]  bg-clip-text  bg-gradient-to-rbg-clip-text bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 text-4xl tracking-tighter   text-transparent md:text-5xl lg:text-6xl"
			>
				Collect data from{" "}
				<span className="bg-gradient-to-r  bg-no-repeat  from-purple-500 via-violet-500 to-pink-500 bg-clip-text text-transparent">
					any website on the internet
				</span>
			</motion.h1>
			<div className="flex items-center justify-center">
				<div className="relative m-2 mx-auto h-96 w-96 scale-[70%] md:scale-100 ">
					<div className="relative h-full w-full rounded-full border border-white dark:border-slate-900">
						...
						<Image
							...
							width={80}
							height={80}
							className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-black bg-black rounded-full bg-opacity-50  "
						/>
